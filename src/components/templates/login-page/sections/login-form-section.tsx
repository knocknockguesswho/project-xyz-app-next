...
const LoginFormSection = () => {
  ...
  return (
    <div className='flex flex-col space-y-6 items-center'>
      <div className='w-full flex flex-col space-y-6' onKeyDownCapture={(e) => { if (e.key === 'Enter') submitForm(ctx.username, ctx.password); }}>
        <InputText
          id='login-username'
          name='username'
      ...
      <div role='group' aria-label='Button Group' className='w-full flex flex-col space-y-4 items-center'>
        ...
        <Divider />
        <Anchor id='go-to-sign-up' variant='outlined' href='/signup'>
          Sign Up
        </Anchor>
      </div>
    </div>
